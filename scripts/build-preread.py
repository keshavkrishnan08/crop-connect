...
heading("Team")
para("**Keshav Krishnan**, founder. His research on the **economic cost of climate-driven migration** gave him a data-level view of how fragile long-distance food supply chains are and why regional, resilient sourcing is where the system is heading, the conviction behind CropConnect. He also **built the entire product solo**, from the agent to the contracts and escrow, which is why a working platform already exists at the pre-seed stage. A **cofounder** leads sourcing and supplier relationships, bringing deep familiarity with the local restaurant and farm market and the connections to onboard both farms and restaurants quickly.")
note("To complete before sending: the cofounder's name and background, and one concrete figure from your climate-migration research.")
...
sources("Sources.  1. Restaurant net-margin and prime-cost benchmarks: National Restaurant Association; Restaurant365 industry benchmarks.  2. National Restaurant Association, 2022 State of the Restaurant Industry.  3. FMI, transparency and foodservice trends, 2023.  4. National Restaurant Association, 2024 industry forecast.  5. U.S. and Indianapolis target-segment restaurant counts and the revenue estimates derived from them are internal estimates.  6. Valuations are peak reported figures from press and PitchBook: Misfits Market (about $2B, 2021) and Choco (about $1.2B, 2022); Afresh has raised about $148M.")
