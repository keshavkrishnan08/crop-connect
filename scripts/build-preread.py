...
para("The product is built and live; we are **pre-revenue**. We are raising **$50,000–$100,000** on a post-money SAFE (**$4M** cap, **20%** discount, MFN), with about **80%** going to sales. The round funds one milestone: **15 paying kitchens and about $13,000 in monthly recurring revenue in Indianapolis within 90 days**, the proof point to raise a priced seed.")
