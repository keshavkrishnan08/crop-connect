    ...
    return (
        <Section>
            <Head eyebrow="Pricing" title="You fund the food at cost."
                body="We are not a distributor, so we make nothing on your food. You pay the farm price and nothing more, with no cut of your sales. On top of that is one monthly service fee. It scales with the number of items and your volume, never the farms or your sales, and it drops the longer you commit." />
